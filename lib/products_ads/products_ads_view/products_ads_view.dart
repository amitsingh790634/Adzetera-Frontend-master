...
class ProductsAdsView extends StatefulWidget {
  const ProductsAdsView({Key? key}) : super(key: key);

  @override
  State<ProductsAdsView> createState() => _ProductsAdsViewState();
}

class _ProductsAdsViewState extends State<ProductsAdsView> {
  @override
