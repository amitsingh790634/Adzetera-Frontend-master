...
class MovieDetailNetflixView extends StatefulWidget {
  const MovieDetailNetflixView({Key? key}) : super(key: key);

  @override
  State<MovieDetailNetflixView> createState() => _MovieDetailNetflixViewState();
}

class _MovieDetailNetflixViewState extends State<MovieDetailNetflixView> {
  @override
